...
@Component({
  templateUrl: 'loginhistory-master.component.html',
  animations: APP_CONFIG.app.animations
})
export class LoginHistoryMasterComponent extends HybrideComponent<AEAccountHistory> implements OnInit {

  constructor(
    injector: Injector,
    private accountHistoryService: AccountHistoryService,
  ) {
    super(injector, AEAccountHistory, accountHistoryService, CriteriaComponent);
    ...
    this.criterias = AECriteriaField.fromObjects([
      ...
      { field: 'loginDate', header: 'Login Date', type: AECriteriaType.DATE, value: '' },
    ]);
